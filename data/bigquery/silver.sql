...
FROM (
    SELECT DISTINCT *  FROM `project-65b029a2-02f6-40de-986.bronze_dataset.departments`
);
...
SELECT DISTINCT 
    ...
    END AS is_quarantined
FROM (
    SELECT DISTINCT * FROM `project-65b029a2-02f6-40de-986.bronze_dataset.providers`
 );
...
SELECT DISTINCT 
  ...
  END AS is_quarantined
FROM (
  SELECT DISTINCT * FROM `project-65b029a2-02f6-40de-986.bronze_dataset.encounters`
);
...
SELECT DISTINCT 
  ...
  END AS is_quarantined
FROM (
  SELECT DISTINCT * FROM `project-65b029a2-02f6-40de-986.bronze_dataset.transactions`
);

-----------------------------
-- 1. Create 
CREATE TABLE IF NOT EXISTS
`project-65b029a2-02f6-40de-986.silver_dataset.claims` (
    claim_id STRING,
...
SELECT
    ...
    END AS is_quarantined
FROM
    `project-65b029a2-02f6-40de-986.bronze_dataset.claims` t1;
